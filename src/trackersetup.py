...
from src.trackers.CMCT import CMCT
...
tracker_class_map: dict[str, type[Any]] = {
    'A4K': A4K, 'ACM': ACM, 'AITHER': AITHER, 'ANT': ANT, 'AR': AR, 'ASC': ASC, 'AZ': AZ, 'BHD': BHD, 'BHDTV': BHDTV, 'BJS': BJS, 'BLU': BLU, 'BT': BT, 'CBR': CBR, 'CMCT': CMCT,
...
http_trackers = {
    'AR', 'ASC', 'AZ', 'BJS', 'BT', 'CMCT', 'CZ', 'FF', 'FL', 'HDB', 'HDS', 'HDT', 'IS', 'MTV', 'PHD', 'PTER', 'PTS', 'TTG'
}
